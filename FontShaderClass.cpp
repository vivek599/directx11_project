...
bool FontShaderClass::Render(ID3D11DeviceContext* context, int indexcount, Mat4 world, Mat4 view, Mat4 projection, ID3D11ShaderResourceView* texture)
{
	bool result;
...
bool FontShaderClass::InitializeShaders(ID3D11Device* device, HWND hwnd, WCHAR* vsPath, WCHAR* psPath)
{
	HRESULT result;
	ID3D10Blob* errMsg;
...
void FontShaderClass::ShutdownShaders()
{
	m_SampleState.Reset();
...
void FontShaderClass::OutputShaderErrorMsg(ID3DBlob* errMsg, HWND hwnd, WCHAR* path)
{
	char* compileError;
...
bool FontShaderClass::SetShaderParameters(ID3D11DeviceContext* context, Mat4 world, Mat4 view, Mat4 projection, ID3D11ShaderResourceView* texture)
{
	HRESULT result;
